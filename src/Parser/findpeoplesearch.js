...
(async () => {
    try {
        ...
        await page.goto('https://www.findpeoplesearch.com/');
        ...
        const results = await page.evaluate(() => {
            ...
            profileList.forEach((profile) => {
                ...
                let age = profile.querySelector('.head_dob').textContent.replace('Age ', '').trim();
                let address = profile.querySelector('a.add1').textContent.trim();
